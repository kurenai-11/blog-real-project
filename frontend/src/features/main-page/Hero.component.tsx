...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col bg-gradient-to-br from-red-900 to-emerald-900 relative min-h-106 items-center justify-center w-full">
      <img
        className="w-full h-full object-cover absolute mix-blend-overlay brightness-80"
        src={imgUrl}
      />
      <div className="py-14 px-4 text-[2.5rem] font-bold text-center rounded-md text-zinc-2 relative">
